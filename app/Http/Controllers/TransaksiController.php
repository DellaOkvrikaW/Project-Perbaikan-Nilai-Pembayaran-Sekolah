    ...
    public function store(Request $request,Siswa $siswa)
    {
        ...
        if($transaksi->save()){
            ...
            $keuangan = Keuangan::create([
                ...
                'jumlah' => $jumlah,
                'total_kas' => $total_kas,
                'keterangan' => 'Pembayaran oleh '.$transaksi->siswa->nama.' pada tanggal '.$transaksi->created_at.' dengan catatan : dibayarkan dengan '.$request->via.
                                ', '.$request->keterangan
            ]);
        }
        ...
        if($request->via == 'tabungan'){
            ...
            $menabung = Tabungan::create([
                ...
                'keperluan' => 'penarikan dilakukan untuk pembayaran melalui tabungan',
            ]);
            ...
            $keuangan = Keuangan::create([
                ...
                'keterangan' => 'Transaksi tabungan oleh '. $menabung->siswa->nama."(".$menabung->siswa->kelas->nama.")".
                                        'melakukan pembayaran sebesar '. $menabung->jumlah
